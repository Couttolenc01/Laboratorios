import { pgnBase } from "mliebelt/pgn-viewer/src/pgnv";
import 'mliebelt/pgn-viewer/src/css/theme.css';
import 'mliebelt/pgn-viewer/src/css/pgnvjs.css';
import { PgnViewerConfiguration } from "mliebelt/pgn-viewer/src/types";
declare global {
...
declare let pgnView: (boardId: string, configuration: PgnViewerConfiguration) => {
    base: {
        ...
        getPgn: () => import("mliebelt/pgn-viewer/pgn-reader/lib").PgnReader;
        generateHTML: () => void;
